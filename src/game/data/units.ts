  ...
  "stoneage.mammoth": {
    ...
    recipe: {
      parts: [
        ...
        { slot: "legs", shape: "box", size: [0.16, 0.42, 0.16], offset: [0.22, -0.42, 0.32], color: "secondary" },
        { slot: "extra", shape: "box", size: [0.16, 0.42, 0.16], offset: [-0.22, -0.42, 0.32], color: "secondary" },
        { slot: "extra", shape: "box", size: [0.16, 0.42, 0.16], offset: [0.22, -0.42, -0.32], color: "secondary" },
        { slot: "extra", shape: "box", size: [0.16, 0.42, 0.16], offset: [-0.22, -0.42, -0.32], color: "secondary" },
        { slot: "weapon", shape: "capsule", size: [0.08, 0.5, 0.08], offset: [0, -0.16, 0.9], color: "secondary" },
        { slot: "shield", shape: "capsule", size: [0.045, 0.32, 0.045], offset: [-0.14, -0.08, 0.82], color: "accent" },
        { slot: "extra", shape: "capsule", size: [0.045, 0.32, 0.045], offset: [0.14, -0.08, 0.82], color: "accent" },
        { slot: "hat", shape: "box", size: [0.22, 0.18, 0.04], offset: [-0.28, 0.16, 0.62], color: "secondary" },
        { slot: "scarf", shape: "box", size: [0.22, 0.18, 0.04], offset: [0.28, 0.16, 0.62], color: "secondary" },
        { slot: "belt", shape: "box", size: [0.74, 0.1, 0.2], offset: [0, 0.12, 0.4], color: "team" },
      ],
    },
